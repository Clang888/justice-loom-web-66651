...
interface FormAdulteryEditorProps {
  onClose: () => void;
}
      ...
      try {
        ...
        await new Promise<void>((resolve) => {
          ...
          img.onload = async () => {
            ...
            link.download = `Petition-Adultery-Page-${pageNum}.png`;
            link.href = dataURL;
    ...
    <div className="fixed inset-0 bg-background/95 z-50 flex flex-col">
      ...
      <div className="flex items-center justify-between p-4 border-b bg-card">
        <div className="flex items-center gap-4">
          ...
          <h2 className="font-semibold">{t("divorceForms.formAdultery")}</h2>
        </div>
...
export default FormAdulteryEditor;
