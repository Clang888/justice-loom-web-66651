...
interface Form2SeparationEditorProps {
  onClose: () => void;
}
...
// Local PDF files - Two Years' Separation form (language-specific)
const PDF_URL_EN = "/forms/form-2-two-years-separation.pdf";
const PDF_URL_ZH = "/forms/form-2-two-years-separation-zh.pdf";
      ...
      try {
        ...
        await new Promise<void>((resolve) => {
          ...
          img.onload = async () => {
            ...
            link.download = `Petition-2-Years-Separation-Page-${pageNum}.png`;
            link.href = dataURL;
    ...
    <div className="fixed inset-0 bg-background/95 z-50 flex flex-col">
      ...
      <div className="flex items-center justify-between p-4 border-b bg-card">
        <div className="flex items-center gap-4">
          ...
          <h2 className="font-semibold">{t("divorceForms.form2Separation")}</h2>
        </div>
...
export default Form2SeparationEditor;
