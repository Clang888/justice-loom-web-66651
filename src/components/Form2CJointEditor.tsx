...
interface Form2CJointEditorProps {
  onClose: () => void;
}
...
const PDF_URL = "/forms/form-2c-joint-application.pdf";

const Form2CJointEditor = ({ onClose }: Form2CJointEditorProps) => {
      ...
      try {
        ...
        await new Promise<void>((resolve) => {
          ...
          img.onload = async () => {
            ...
            link.download = `Form-2C-Joint-Application-Page-${pageNum}.png`;
            link.href = dataURL;
    ...
    <div className="fixed inset-0 bg-background/95 z-50 flex flex-col">
      ...
      <div className="flex items-center justify-between p-4 border-b bg-card">
        <div className="flex items-center gap-4">
          ...
          <h2 className="font-semibold">Petition_Form 2C: Joint Application for Divorce</h2>
        </div>
...
export default Form2CJointEditor;
